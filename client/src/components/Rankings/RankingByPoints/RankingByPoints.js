...
class RankingByPoints extends Component {
  componentDidMount() {
    this.props.getRankings("/api/users/points");
  }
  render() {
    ...
    return (
      <div className="rankingsByPoints">
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h1 className="display-4 text-center">Ranking by Points</h1>
              <br />
              {rankingContent}
            </div>
          </div>
